...
1. Include the stylesheet on your document's `<head>`
  ...
  ```
  Instead of installing you may use the remote version (hosted by [jsDelivr](https://www.jsdelivr.com/package/npm/animate.css) and [CDNJS](https://cdnjs.com/libraries/animate.css)):
  ```html
  <head>
    <link rel="stylesheet"
